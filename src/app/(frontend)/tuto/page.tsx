...
export default async function TutoPage(): Promise<React.JSX.Element> {
	...
	return (
		<>
			{/* Hero Banner */}
			<AnimatedSection variant="fadeIn" className="relative min-h-[50vh] w-full overflow-hidden bg-gradient-to-br from-primary/20 via-secondary/30 to-accent/20 flex items-end">
				...
				<div className="relative z-10 w-full max-w-5xl mx-auto px-6 pb-12">
					...
					<p className="text-lg md:text-xl text-muted-foreground max-w-3xl leading-relaxed">
						Apprenez à gérer le site : créer des articles de blog, optimiser le référencement, gérer les photos et modifier la page d&apos;accueil.
					</p>
				</div>
			</AnimatedSection>
			...
			<div className="bg-background">
				<div className="mx-auto max-w-4xl px-6 py-16 lg:py-24">
					<AnimatedSection variant="fadeInUp" delay={0.1} as="article" className="prose prose-lg max-w-none prose-headings:font-display prose-h2:text-3xl prose-h3:text-2xl prose-h4:text-xl prose-a:text-primary hover:prose-a:text-primary/80">
...
Accueil chaleureux pour vos enfants. Plus de 20 ans d'expérience.`}</code></pre>
						...
						<ul>
							...
							<li><strong>URL résultante :</strong> <code>https://isabelle-cinquin.fr/blog/bienfaits-activites-plein-air-tout-petits</code></li>
						...
						<ul>
							...
							<li><strong>Exemple :</strong> &quot;Découvrez pourquoi les activités extérieures sont essentielles pour le développement des enfants. Conseils pratiques d&apos;une assistante maternelle.&quot;</li>
						</ul>
					...
					{/* Back navigation */}
					<AnimatedSection variant="fadeInUp" delay={0.2} as="div" className="mt-12 pt-8 border-t border-border">
