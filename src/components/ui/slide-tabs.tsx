...
const Tab = React.forwardRef<HTMLLIElement, TabProps>(({ children, href, setPosition, onClick }, ref) => {
	return (
		<li
			ref={ref}
			onClick={onClick}
		...
		>
			<a
				href={href}
				className="block px-4 py-2 text-sm font-medium text-white mix-blend-difference md:px-5 md:py-2.5 md:text-base"
			>
				{children}
			</a>
		</li>
